                ...
                <div class="col-sm-7">
                    <div class="header-content">
                        <div class="header-content-inner">
                            ...
                            <a href="searchdatafront.php" class="btn btn-outline btn-xl page-scroll"> &nbsp&nbsp &nbsp&nbsp***SEARCH*** &nbsp&nbsp &nbsp&nbsp</a>
                        </div>
                    </div>
                </div>
                 <div class="col-sm-5">
                        ...
                        <div class="device-mockup iphone6 portrait white">
                            <div class="device">
                                <div class="screen">
                                    <?php 
                                    $idt=$_GET['idm'] ;?> 
                                   <a href="get_people_book.php?idt=<?=$idt?>" class="btn btn-outline btn-xl page-scroll">  &nbsp&nbsp  &nbsp &nbsp BOOKS  &nbsp&nbsp&nbsp &nbsp</a>
                                    
                                </div>
                                 <div class="screen">
                                    <?php 
                                    $idt=$_GET['idm'] ;?> 
                                    <a href="get_people_movie.php?idt=<?=$idt?>" class="btn btn-outline btn-xl page-scroll"> &nbsp &nbsp&nbsp  MOVIES &nbsp&nbsp &nbsp&nbsp</a>
                                </div>
                                 <div class="screen">
                                   <?php 
                                    $idt=$_GET['idm'] ;?> 

                                     <a href="get_people_tv.php?idt=<?=$idt?>" class="btn btn-outline btn-xl page-scroll"> &nbsp&nbsp&nbsp  TVShows  &nbsp&nbsp&nbsp</a>
