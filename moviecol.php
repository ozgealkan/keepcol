...
if (mysqli_connect_errno())
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
    ...
    $sonuc=mysqli_query($con,"SELECT * FROM movie,users WHERE movie.id='$id' AND users.email='$email'");
...
header("Location:getmoviecol.php")

                   ?>
      
     <a href="getmoviecol.php"><script> alert("Succesfully Added");</script></a>
