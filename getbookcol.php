        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="getfollowing.php" href="#features">FOLLOWING</a>
                    </li>
...
// Perform queries 
$sonuc=mysqli_query($con,"SELECT * FROM book_user,books WHERE book_user.book_id=books.id AND book_user.user_id = '$userId'");
while($book = mysqli_fetch_array($sonuc))
{
              
     ?>
<a href="likebook.php?idl=<?=$book['id']?>"><img src="img/lık.png" height=40 width=60 backgroundcolor="pink" /></a>
    <?php                          
