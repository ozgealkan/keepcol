        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="getpeople_suggest.php">PEOPLE</a>
                    </li>
                    <li>
                ...
                <div class="col-sm-7">
                    <div class="header-content">
                        <div class="header-content-inner">
                            ...
                            <a href="searchdatafront.php" class="btn btn-outline btn-xl page-scroll"> &nbsp&nbsp***SEARCH*** &nbsp&nbsp</a>
                        </div>
                    </div>
                </div>
                 <div class="col-sm-5">
                    <div class="device-container">
                        <div class="device-mockup iphone6 portrait white">
                            <div class="device">
                                <div class="screen">
                                   <a href="getbookcol.php" class="btn btn-outline btn-xl page-scroll">  &nbsp&nbsp &nbsp&nbsp my BOOKS &nbsp&nbsp &nbsp&nbsp</a>
                                    
                                </div>
                                 <div class="screen">
                                    <a href="getmoviecol.php" class="btn btn-outline btn-xl page-scroll">  &nbsp&nbsp &nbsp&nbspmy MOVIES &nbsp&nbsp &nbsp</a>
                                </div>
                                 <div class="screen">
                                   
                                     <a href="gettvcol.php" class="btn btn-outline btn-xl page-scroll"> &nbsp&nbspmy TVShows &nbsp&nbsp &nbsp</a>
